...
* `process_emissions`: for each of the five primary pollutants, runs `intersect_gemoetries` and then `allocate_emissions` to return the geodataframes of emissions of each primary pollutant released in the `layer` allocated to the ISRM grid
