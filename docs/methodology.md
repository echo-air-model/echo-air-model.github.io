...
If your run includes emissions occurring between 140 and 760 meters, please see the additional documentation [here](https://echo-air-model.github.io/docs/other_information/isrm_hole_patch.html). Emission files with larger areas—areas exceeding 2500 km^2—are less likely to provide accurate data for disparity, equity, and environmental justice analyses, and will trigger a warning output, although processing would still continue.
